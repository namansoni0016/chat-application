    ...
    return (
        <div className="w-full border p-4 shadow-sm bg-white flex flex-col gap-3">
            <div className="flex items-center mb-4">
                <input type="text" placeholder="Message..." className="flex-grow outline-none border-none bg-transparent font-bold text-gray-500" />
                <button className="text-green-700 hover:text-green-600 text-xl ml-2">
                    <IoMdSend />
                </button>
            </div>
